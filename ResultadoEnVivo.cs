...
public partial class ResultadoEnvivo : Form
{
    public ResultadoEnvivo()
    {
        InitializeComponent();
    }

    private async void ResultadoEnvivo_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string url = "https://statsinfo.co/live/1/";
    ...
    private void ResultadoEnVivo_Deactivate(object sender, EventArgs e)
    {

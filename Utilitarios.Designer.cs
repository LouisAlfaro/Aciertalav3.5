...
partial class Utilitarios : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.KeyDown += Utilitarios_KeyDown;

        this.Deactivate += new EventHandler(this.Utilitarios_Deactivate);
    }

    private void Utilitarios_KeyDown(object sender, KeyEventArgs e)
    {

...
partial class MarcadoresEnVivo
{
    ...
    private void InitializeComponent()
    {
        ...
        this.Name = "MarcadoresEnVivo";
        this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
        this.Text = "MarcadoresEnVivo";
        this.Load += new System.EventHandler(this.MarcadoresEnVivo_Load);
        ((System.ComponentModel.ISupportInitialize)(this.browser)).EndInit();
        this.ResumeLayout(false);

        this.Deactivate += new EventHandler(this.MarcadoresEnVivo_Deactivate);
    }
}

...
partial class ResultadoEnvivo
{
    ...
    private void InitializeComponent()
    {
        ...
        this.Name = "ResultadoEnvivo";
        this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
        this.Text = "ResultadoEnvivo";
        this.Load += new System.EventHandler(this.ResultadoEnvivo_Load);
        ((System.ComponentModel.ISupportInitialize)(this.browser)).EndInit();
        this.ResumeLayout(false);

        this.Deactivate += new EventHandler(this.ResultadoEnVivo_Deactivate);
    }
}

...
partial class ConexionRemota : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.Deactivate += new System.EventHandler(this.ConexionRemota_Deactivate);
        this.ResumeLayout(false);

        // Manejo de cierre con Escape
        this.KeyDown += ConexionRemota_KeyDown;
    }

    private void ConexionRemota_KeyDown(object sender, KeyEventArgs e)
    {
